      ...
      <div class="position">
        <div class="positionico" v-bind:style="{'margin-left':engineleft}">
          <div class="positionfont">实际寿命
            <!-- <img src="../../assets/img/Combined.png" height="20">&nbsp;&nbsp;实际寿命 -->
          </div>
        </div>
      </div>
      <div class="progress">
...
@Component({})
export default class lifeharvester extends Vue {
  myChart1 = null;
  myChart2 = null;
