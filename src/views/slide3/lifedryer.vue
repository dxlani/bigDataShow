...
@Component({})
export default class lifedryer extends Vue {
  myChart5 = null;
  myChart6 = null;
  ...
  init() {
    ...
    let dom2 = document.getElementById("chart6");
    //dom.style.width = "90%";
    //dom2.style.width = "90%";

    if (!this.myChart5) {
      this.myChart5 = echarts.init(dom);
    }
    if (!this.myChart6) {
      this.myChart6 = echarts.init(dom2);
    }
    this.myChart5.clear();
    this.myChart6.clear();

    if (this.option && typeof this.option === "object") {
      this.myChart5.setOption(this.option, true);
    }
    if (this.option2 && typeof this.option2 === "object") {
      this.myChart6.setOption(this.option2, true);
    }
  }
  GetPartsLifeCycle() {
